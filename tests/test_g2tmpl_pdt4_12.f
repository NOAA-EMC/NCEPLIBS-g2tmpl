...
!       It test PDT4.12 by changing: weighted_mean_all_mem = 1, unweighted_mean_all_mem = 0
!       and std_devn_res_cluster_mean = 2. Then, It calls g2sec4_temp12 routine to write
!       NEW PDT4.12
!
...
!
         ...
         call g2sec4_temp12(icatg,iparm,typ_gen_proc_key,gen_proc_or_mod_key,      &
           ...
           print *,' for  new PDT 4.12                '
           print *, ' weighted_mean_all_mem = 1 '
           print *,' '
         ...
         call g2sec4_temp12(icatg,iparm,typ_gen_proc_key,gen_proc_or_mod_key,      &
           ...
           print *,' Compiled with NEW g2tmpl library '
           print *,' for  new PDT 4.12                '
           print *, ' unweighted_mean_all_mem = 0 '
           print *,' '
           write(6,'(A,1x,i0,a,80(1x,I0))')'  NEW    PRODUCT TEMPLATE 4.', &
                ipdsnum,' : ',(ipdstmpl12(j),j=1,ipdstmpllen)
           print *,' '
         ...
         call g2sec4_temp12(icatg,iparm,typ_gen_proc_key,gen_proc_or_mod_key,      &
           ...
           print *,' Compiled with NEW g2tmpl library '
           print *,' for  new PDT 4.12                '
           print *, ' std_devn_res_cluster_mean = 2 '
           print *,' '
           write(6,'(A,1x,i0,a,80(1x,I0))')'  NEW    PRODUCT TEMPLATE 4.', &
                ipdsnum,' : ',(ipdstmpl12(j),j=1,ipdstmpllen)
           print *,' '
