...
!       It tests parameters in table 4.2 (test_params_grib2_tbl_new) by changing mnemonic in
!       params_grib2_tbl_new table. Then, it calls search_for_4dot2_entry routine and 
