...
!       It uses to test PDT4.1 by changing the original PDT4.1 with "typ_gen_proc_key"
!       and "gen_proc_or_mod_key"
...
!       0   4 4 0 107 0 0 1  6 103 0     2 255 0      0 3 5 10  ! PDT 4.1
         ...
         call g2sec4_temp1(icatg,iparm,typ_gen_proc_key,gen_proc_or_mod_key,       &
           ...
           write(6,'(A,1x,i0,a,80(1x,I0))')'Original PRODUCT TEMPLATE 4.', &
                ipdsnum,' : ',(ipdstmpl1_old(j),j=1,ipdstmpllen)
           print *,' '
           print *,' Compiled with NEW g2tmpl library '
           print *,' for  new PDT 4.1                '
           print *,' '
           write(6,'(A,1x,i0,a,80(1x,I0))')'  NEW    PRODUCT TEMPLATE 4.', &
                ipdsnum,' : ',(ipdstmpl1(j),j=1,ipdstmpllen)
           print *,' '
           print *," Both Original and New PRODUCT TEMPLATE 4.1 are SAME "
           print *,'   PASS   '
           print *,' '
