 ...
 *  Log:				                                	*
 *  J. Ator/NCEP	02/10							*
 *  J. Ator/NCEP	12/19	Move qsort to separate new function		*
 *******************************************************************************/
 ...
 *										*
 * Usage:									*
 *      call sort_and_write_4dot2 ( filename, iret )				*
 *										*
 * Input parameters:								*
 *	filename	character*(*)	Filename to which to write the sorted	*
 *					output.  Directory prefixes or other	*
 *					local filesystem notation is allowed up	*
 *					to 120 total characters.		*
 *										*
 * Output parameters:								*
 *	iret		integer		Return code:				*
 *					 0 = normal return			*
 *					-1 = filename was more than		*
 *					     120 characters			*
 ...
 *										*
 * In order for this function to be used, the table must already be in sorted	*
 * order with respect to the mnemonic and according to the criteria of the	*
 * compar() function.  If this has not already been done, it can be done by	*
 * calling the sort_and_write_4dot2() function prior to calling	this function.	*	
 *										*
 * Usage:									*
