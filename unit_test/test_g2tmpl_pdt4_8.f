...
!
!       This program uses to test routine g2sec4_temp8 in g2tmpl library
!       to verify the scaled value of first fixed surface and scaled value
!       of second fixed surface in product definition template 4.8
!
        ...
        integer(4) :: ipdstmpl8_old(29)=(/2, 220, 2, 0, 84, 0, 0, 1, 10, 100, 0, 40000, 100, &
               0, 100000, 2014, 12, 24, 12, 0, 0, 1, 0, 2, 2, 1, 1, 255, 0/)

!       PRODUCT TEMPLATE 4. 8
!       2 220 2 0 84 0 0  1 10 100 0 40000 100 0 100000 2014 12 24 12 0 0 1 0 2 2 1 1 255 0
! 
         icatg=2
         iparm=220
         ...
         call g2sec4_temp8(icatg,iparm,typ_gen_proc_key,   &
           ...
           print *,' It fixed  the scale value of first fixed surface= 400000'
